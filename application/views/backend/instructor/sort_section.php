                        ...
                        <div class="col-md-12">
                            <div class="">
                                <h5 class="mt-0"><?php echo get_phrase('list_of_sections'); ?>
                                    <button type="button" class="btn btn-primary shadow-none btn-sm btn-rounded alignToTitle" id = "section-sort-btn" onclick="sort()" name="button"><?php echo get_phrase('update_sorting'); ?></button>
                                </h5>
