<form  class="form-horizontal form-groups-bordered" action="<?php echo site_url('admin/change_course_status/'.$param2); ?>" method="post">
  <div class="form-group">
     ...
     <input type="text" name = "mail_subject" class="form-control form_control_bg" placeholder="<?php echo get_phrase('mail_subject'); ?>" required>
  </div>

  <div class="form-group">
    <label><?php echo get_phrase('mail_body'); ?></label>
      <textarea name = "mail_body" class="form-control form_control_bg" required rows="6" placeholder="<?php echo get_phrase('mail_subject'); ?>"></textarea>
  </div>
  ...
  <div class="text-right">
      <button class = "btn btn-primary shadow-none" type="submit" name="button"><?php echo get_phrase('send_mail'); ?></button>
  </div>
</form>
