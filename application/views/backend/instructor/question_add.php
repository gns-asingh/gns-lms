<form action="<?php echo site_url('instructor/quiz_questions/'.$param2.'/add'); ?>" method="post" id = 'mcq_form'>
    ...
    <div class="form-group" id='multiple_choice_question'>
        ...
        <div class="input-group">
            ...
            <div class="input-group-append " style="padding: 0px"><button type="button" class="btn btn-secondary btn-sm pull-right shadow-none append_btn_set" name="button" onclick="showOptions(jQuery('#number_of_options').val())" style="border-radius: 0px;"><i class="fa fa-check"></i></button></div>
        </div>
    </div>
...
$('#submitButton').click( function(event) {
    $.ajax({
        url: '<?php echo site_url('instructor/quiz_questions/'.$param2.'/add'); ?>',
        type: 'post',
