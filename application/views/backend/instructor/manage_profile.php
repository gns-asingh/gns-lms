	...
	<div class="col-xl-12">
		<div class="admin_title_bg">
			<div class="card-body setPageTitle">
				...
				<span style="vertical-align:middle;position:relative;top:2px;"><?php echo get_phrase('manage_profile'); ?></span>
				</h4>
			</div> <!-- end card body-->
		</div> <!-- end card -->
	</div><!-- end col-->
			...
			<div class="card shadow-none">
				<div class="admin_card_border">
					...
					foreach($edit_data as $row):
						...
						<?php echo form_open(site_url('instructor/manage_profile/update_profile_info/'.$row['id']) , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
			...
			<div class="admin_card_border">
				<div class="card-body">
					<?php foreach($edit_data as $row): ?>
						<?php echo form_open(site_url('instructor/manage_profile/change_password/'.$row['id']) , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
						<div class="form-group">
