        ...
        <div class="admin_title_bg">
            <div class="card-body setPageTitle">
                <h4 class="page-title"> 
                    ...
                    <span style="vertical-align:middle;position:relative;top:2px;"><?php echo get_phrase('courses'); ?></span>
                    <a href="<?php echo site_url('admin/course_form/add_course'); ?>" class="btn btn-primary add_btn_set box-shadow-none btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_new_course'); ?></a>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
                ...
                <div class="mb-20">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div>
                                <a href="<?php echo site_url('admin/courses'); ?>" class="admin_text_white">
                                    <div class="card admin_bg_info shadow-none m-0">
                                        <div class="card-body text-center">
            ...
            <div class="admin_card_border">
                <div>
                    <div class="admin_card_title">
                        <h5 class="mb-0 header-title"><?php echo get_phrase('course_list'); ?></h5>
                    </div>

                    <div class="card-body">
                        <form class="row" action="<?php echo site_url('admin/courses'); ?>" method="get">
                            <!-- Course Categories -->
                            <div class="col-xl-3">
                                <div class="form-group">
                                    <label for="category_id"><?php echo get_phrase('categories'); ?></label>
                                    <select class="form-control select2 select_box_bg " data-toggle="select2" name="category_id" id="category_id">
                            ...
                            <div class="col-xl-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 select_box_bg" data-toggle="select2" name="status" id = 'status'>
                            ...
                            <div class="col-xl-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 select_box_bg" data-toggle="select2" name="instructor_id" id = 'instructor_id'>
