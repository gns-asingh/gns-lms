    ...
    <div class="col-xl-12">
        <div class="admin_title_bg">
            <div class="card-body setPageTitle">
                <h4 class="page-title"> 
                    <i class="dripicons-archive title_icon"></i> 
                    <span style="vertical-align:middle;position:relative;top:2px;"><?php echo get_phrase('add_new_course'); ?></span>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
            ...
            <div class="card box-shadow-none">
                <div class="admin_card_border">
                    <div class="admin_card_title">
                        <h5 class="header-title mb-1"><?php echo get_phrase('course_adding_form'); ?>
                            <a href="<?php echo site_url('admin/courses'); ?>" class="alignToTitle btn btn-secondary box-shadow-none add_btn_set btn-rounded btn-sm"> <i class=" mdi mdi-keyboard-backspace"></i> <?php echo get_phrase('back_to_course_list'); ?></a>
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-xl-8">
                                                        ...
                                                        <div class="form-group row mb-3">
                                                            ...
                                                            <div class="col-md-10">
                                                                <textarea name="short_description" id = "short_description" class="form-control form_control_bg"></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row mb-3">
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        <div class="offset-md-2 col-md-10">
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                <label class="custom-control-label custom_control_bg" for="is_top_course"><?php echo get_phrase('check_if_this_course_is_top_course'); ?></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div> <!-- end col -->
                                                        ...
                                                        <div class="col-md-10">
                                                            <div id = "requirement_area">
                                                                <div class="d-flex mt-2">
                                                                    ...
                                                                    <div class="">
                                                                        <button type="button" class="btn btn-success box-shadow-none btn-sm" style="" name="button" onclick="appendRequirement()"> <i class="fa fa-plus"></i> </button>
                                                                    </div>
                                                                </div>
                                                                <div id = "blank_requirement_field">
                                                                    <div class="d-flex mt-2">
                                                                        ...
                                                                        <div class="">
                                                                            <button type="button" class="btn btn-danger box-shadow-none btn-sm" style="margin-top: 0px;" name="button" onclick="removeRequirement(this)"> <i class="fa fa-minus"></i> </button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        <div class="offset-md-2 col-md-10">
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                <label class="custom-control-label custom_form_bg" for="is_free_course"><?php echo get_phrase('check_if_this_is_a_free_course'); ?></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        <div class="offset-md-2 col-md-10">
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                <label class="custom-control-label custom_form_bg" for="discount_flag"><?php echo get_phrase('check_if_this_course_has_discount'); ?></label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="bootstraptag">
                                                                <input type="text" class="form-control form_control_bg bootstrap-tag-input" id = "meta_keywords" name="meta_keywords" data-role="tagsinput" style="width: 100%;"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div> <!-- end col -->
