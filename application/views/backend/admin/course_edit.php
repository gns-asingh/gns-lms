    ...
    <div class="col-xl-12">
        <div class="admin_title_bg">
            <div class="card-body setPageTitle">
                <h4 class="page-title"> <i class="dripicons-archive title_icon"></i> 
                    <span style="vertical-align:middle;position:relative;top:2px;"><?php echo get_phrase('update').': '.$course_details['title']; ?></span>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
            ...
            <div class="card box-shadow-none">
                <div class="admin_card_border">
                    <div class="admin_card_title">
                        <h5 class="header-title mb-1"><?php echo get_phrase('course_manager'); ?>
                            <a href="<?php echo site_url('admin/preview/'.$course_id); ?>" class="alignToTitle btn btn-secondary box-shadow-none btn-rounded add_btn_set btn-sm ml-1" target="_blank"><?php echo get_phrase('view_on_frontend'); ?> <i class="mdi mdi-arrow-right"></i> </a>
                            <a href="<?php echo site_url('admin/courses'); ?>" class="alignToTitle btn btn-secondary add_btn_set box-shadow-none btn-rounded btn-sm"> <i class=" mdi mdi-keyboard-backspace"></i> <?php echo get_phrase('back_to_course_list'); ?></a>
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-xl-8">
                                                        ...
                                                        <div class="form-group row mb-3">
                                                            ...
                                                            <div class="col-md-10">
                                                                <select class="form-control select2 form_control_bg" data-toggle="select2" name="sub_category_id" id="sub_category_id" required>
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select class="form-control select2 form_control_bg" data-toggle="select2" name="level" id="level">
                                                        ...
                                                        <div class="form-group row mb-3">
                                                            ...
                                                            <div class="col-md-10">
                                                        <select class="form-control select2 form_control_bg" data-toggle="select2" name="instructor_id" id="instructor_id" required>
                                                                <option value=""><?php echo get_phrase('select_a_instructor'); ?></option>
                                                                        <?php foreach ($instructors->result_array() as $instructors): ?>
                                                                        <option value="<?php echo $instructors['id']; ?>" <?php if($instructors['id'] == $course_details['user_id']) echo 'selected'; ?>><?php echo $instructors['first_name'].' '.$instructors['last_name']; ?></option>
                                                                    <?php endforeach; ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <?php if (count(json_decode($course_details['requirements'])) > 0): ?>
                                                                        ...
                                                                        <?php if ($counter == 0):
                                                                            ...
                                                                            <div class="d-flex mt-2">
                                                                                ...
                                                                                <div class="">
                                                                                    <button type="button" class="btn btn-success btn-sm box-shadow-none" style="" name="button" onclick="appendRequirement()"> <i class="fa fa-plus"></i> </button>
                                                                                </div>
                                                                            </div>
                                                                        <?php else: ?>
                                                                            <div class="d-flex mt-2">
                                                                                ...
                                                                                <div class="">
                                                                                    <button type="button" class="btn btn-danger btn-sm box-shadow-none" style="margin-top: 0px;" name="button" onclick="removeRequirement(this)"> <i class="fa fa-minus"></i> </button>
                                                                                </div>
                                                                            </div>
                                                                        <?php endif; ?>
                                                                    <?php endforeach; ?>
                                                                    ...
                                                                    <?php if (count(json_decode($course_details['outcomes'])) > 0): ?>
                                                                        ...
                                                                        <?php if ($counter == 0):
                                                                            ...
                                                                            <div class="d-flex mt-2">
                                                                                ...
                                                                                <div class="">
                                                                                    <button type="button" class="btn btn-success btn-sm box-shadow-none" name="button" onclick="appendOutcome()"> <i class="fa fa-plus"></i> </button>
                                                                                </div>
                                                                            </div>
                                                                        <?php else: ?>
                                                                            <div class="d-flex mt-2">
                                                                                ...
                                                                                <div class="">
                                                                                    <button type="button" class="btn btn-danger btn-sm box-shadow-none" style="margin-top: 0px;" name="button" onclick="removeOutcome(this)"> <i class="fa fa-minus"></i> </button>
                                                                                </div>
                                                                            </div>
                                                                        <?php endif; ?>
                                                                    <?php endforeach; ?>
                                                        ...
                                                        <div class="form-group row mb-3">
                                                            <div class="offset-md-2 col-md-10">
                                                                <div class="custom-control custom-checkbox">
                                                                    ...
                                                                    <label class="custom-control-label custom_file_bg" for="is_free_course"><?php echo get_phrase('check_if_this_is_a_free_course'); ?></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row mb-3">
                                                            <div class="offset-md-2 col-md-10">
                                                                <div class="custom-control custom-checkbox">
                                                                    ...
                                                                    <label class="custom-control-label custom_file_bg" for="discount_flag"><?php echo get_phrase('check_if_this_course_has_discount'); ?></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-xl-8">
                                                        <div class="form-group row mb-3">
                                                            ...
                                                            <div class="col-md-10">
                                                                <select class="form-control select2 form_control_bg" data-toggle="select2" name="course_overview_provider" id="course_overview_provider">
