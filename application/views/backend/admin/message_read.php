	        ...
	        <div>
				...
				<div class="card-body">
					<div class="chat-conversation ">
						<ul class="chatBox conversation-list slimscroll" style="max-height: 250px;">
							<?php
							...
							?>
								...
								<li class="clearfix <?php if($first_sender != $sender_id )echo 'odd'; ?>">
									...
									<div class="conversation-text">
										<div class="ctext-wrap form_control_bg">
											<i>
						...
						<form method="post" action="<?php echo site_url('admin/message/send_reply/'.$current_message_thread_code); ?>" class="needs-validation" novalidate name="chat-form" id="chat-form">
							<div class="row">
								<div class="col">
									<input type="text" name="message" class="form-control form_control_bg chat-input" placeholder="Enter your text" required>
									<div class="invalid-feedback">
										<?php echo get_phrase('Please enter your messsage'); ?>
									</div>
								</div>
								<div class="col-auto">
									<button type="submit" class="btn btn-primary box-shadow-none chat-send btn-block waves-effect waves-light"><?php echo get_phrase('sent_message'); ?></button>
								</div>
							</div>
						</form>
