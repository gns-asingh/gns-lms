                ...
                <div class="admin_card_border">
                    <div>
                        <div class="admin_card_title">
                            <h5 class="mb-0 header-title"><?php echo get_phrase('system_settings');?></h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name = "system_name" id = "system_name" class="form-control form_control_bg" value="<?php echo get_settings('system_name');  ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="system_title"><?php echo get_phrase('website_title'); ?><span class="required">*</span></label>
                                            <input type="text" name = "system_title" id = "system_title" class="form-control form_control_bg" value="<?php echo get_settings('system_title');  ?>" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="website_description" id = "website_description" class="form-control form_control_bg" rows="5"><?php echo get_settings('website_description');  ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name = "author" id = "author" class="form-control form_control_bg" value="<?php echo get_settings('author');  ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="slogan"><?php echo get_phrase('slogan'); ?><span class="required">*</span></label>
                                            <input type="text" name = "slogan" id = "slogan" class="form-control form_control_bg" value="<?php echo get_settings('slogan');  ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name = "system_email" id = "system_email" class="form-control form_control_bg" value="<?php echo get_settings('system_email');  ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="address"><?php echo get_phrase('address'); ?></label>
                                            <textarea name="address" id = "address" class="form-control form_control_bg" rows="5"><?php echo get_settings('address');  ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name = "phone" id = "phone" class="form-control form_control_bg" value="<?php echo get_settings('phone');  ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name = "youtube_api_key" id = "youtube_api_key" class="form-control form_control_bg" value="<?php echo get_settings('youtube_api_key');  ?>" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name = "footer_link" id = "footer_link" class="form-control form_control_bg" value="<?php echo get_settings('footer_link');  ?>">
                                        </div>
                                    </div>
                                </div>
