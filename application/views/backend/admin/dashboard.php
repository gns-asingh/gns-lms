        ...
        <div class="admin_title_bg">
            <div class="card-body setPageTitle">
                ...
                <h5 class="page-title"> 
                    ...
                    <span class="admin_title_color"><?php echo get_phrase('dashboard'); ?></span>
                </h5>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
                            ...
                            <div class="col-sm-6 col-xl-3">
                                <div>
                                    <a href="<?php echo site_url('admin/enrol_history'); ?>" class="admin_text_white">
                                        <div class="card admin_bg_warning shadow-none m-0 border-left">
                                            <div class="card-body text-center">
                            ...
                            <div class="col-sm-6 col-xl-3">
                                <div>
                                    <a href="<?php echo site_url('admin/users'); ?>" class="admin_text_white">
                                        <div class="card admin_bg_danger shadow-none m-0 border-left">
                                            <div class="card-body text-center">
                ...
                <div class="admin_card_border">
                    <div>
                        <div class="admin_card_title">
                            <h5 class="header-title m-0"><?php echo get_phrase('course_overview'); ?></h5>
                        </div>
