            ...
            <div class="card box-shadow-none">
                <div class="admin_card_border">
                    <div class="admin_card_title">
                        <h5 class="header-title mb-0"><?php echo get_phrase('instructor_edit_form'); ?></h5>
                    </div>
                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control form_control_bg" id="first_name" name="first_name" value="<?php echo $user_data['first_name']; ?>" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="last_name"><?php echo get_phrase('last_name'); ?> <span class="required">*</span> </label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control form_control_bg" id="last_name" name="last_name" value="<?php echo $user_data['last_name']; ?>" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                        ...
                                                        <div class="flex-grow-1 mt-1 pl-3">
                                                            <div class="input-group">
                                                                <div class="custom-file">
                                                                    ...
                                                                    <label class="custom-file-label ellipsis custom_file_bg" for="user_image"><?php echo get_phrase('choose_user_image'); ?></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="email" id="email" name="email" class="form-control form_control_bg" value="<?php echo $user_data['email']; ?>" required>
                                                    </div>
                                                </div>
                                            </div> <!-- end col -->
                                        </div> <!-- end row -->
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="facebook_link" name="facebook_link" class="form-control form_control_bg" value="<?php echo $social_links['facebook']; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="twitter_link"><?php echo get_phrase('twitter'); ?></label>
                                                    <div class="col-md-9">
                                                        <input type="text" id="twitter_link" name="twitter_link" class="form-control form_control_bg" value="<?php echo $social_links['twitter']; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="linkedin_link"><?php echo get_phrase('linkedin'); ?></label>
                                                    <div class="col-md-9">
                                                        <input type="text" id="linkedin_link" name="linkedin_link" class="form-control form_control_bg" value="<?php echo $social_links['linkedin']; ?>">
                                                    </div>
                                                </div>
                                            </div> <!-- end col -->
                                        </div> <!-- end row -->
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="paypal_client_id" name="paypal_client_id" class="form-control form_control_bg" value="<?php echo $paypal_keys[0]['production_client_id']; ?>">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="stripe_public_key" name="stripe_public_key" class="form-control form_control_bg" value="<?php echo $stripe_keys[0]['public_live_key']; ?>">
                                                        <small><?php echo get_phrase("required_for_instructor"); ?></small>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="stripe_secret_key" name="stripe_secret_key" class="form-control form_control_bg" value="<?php echo $stripe_keys[0]['secret_live_key']; ?>">
                                                        <small><?php echo get_phrase("required_for_instructor"); ?></small>
                                                    </div>
                                                </div>
                                            </div> <!-- end col -->
