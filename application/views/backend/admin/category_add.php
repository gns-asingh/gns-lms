        ...
        <div class="admin_title_bg">
            <div class="card-body setPageTitle">
                <h4 class="page-title"> <i class="dripicons-network-1 title_icon"></i>
                    <span style="vertical-align:middle;position:relative;top:2px;"><?php echo get_phrase('add_new_category'); ?></span>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
                    ...
                    <div>
                        <div class="admin_card_border">
                            <div class="admin_card_title">
                                <h5 class="mb-0 header-title"><?php echo get_phrase('category_add_form'); ?></h5>
                            </div>
                            <div class="card-body">
                                <form class="required-form" action="<?php echo site_url('admin/categories/add'); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group" hidden>
                                        ...
                                        <select class="form-control form_control_bg select2" data-toggle="select2" name="parent" id="parent" onchange="checkCategoryType(this.value)">
