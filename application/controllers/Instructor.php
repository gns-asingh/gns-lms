...
class Instructor extends CI_Controller {
  ...
  public function categories($param1 = "", $param2 = "") {
    ...
    if ($param1 == 'add') {
      ...
      redirect(site_url('instructor/categories'), 'refresh');
    }
    elseif ($param1 == "edit") {
  ...
  public function users($param1 = "", $param2 = "") {
    ...
    if ($param1 == "add") {
      ...
      redirect(site_url('instructor/users'), 'refresh');
    }
    elseif ($param1 == "edit") {
  ...
  public function enrol_student($param1 = "") {
    ...
    if ($param1 == 'enrol') {
      ...
      redirect(site_url('instructor/enrol_history'), 'refresh');
    }
  ...
  public function payment_history_delete($param1 = "", $redirect_to = "") {
    ...
    redirect(site_url('instructor/'.$redirect_to), 'refresh');
  }
  ...
  public function system_settings($param1 = "") {
    ...
    if ($param1 == 'system_update') {
      ...
      redirect(site_url('instructor/system_settings'), 'refresh');
    }
  ...
  public function frontend_settings($param1 = "") {
    ...
    if ($param1 == 'frontend_update') {
      ...
      redirect(site_url('instructor/frontend_settings'), 'refresh');
    }
  ...
  public function payment_settings($param1 = "") {
    ...
    if ($param1 == 'system_currency') {
      ...
      redirect(site_url('instructor/payment_settings'), 'refresh');
    }
  ...
  public function smtp_settings($param1 = "") {
    ...
    if ($param1 == 'update') {
      ...
      redirect(site_url('instructor/smtp_settings'), 'refresh');
    }
  ...
  public function instructor_settings($param1 = "") {
    ...
    if ($param1 == 'update') {
      ...
      redirect(site_url('instructor/instructor_settings'), 'refresh');
    }
  ...
  public function lessons($course_id = "", $param1 = "", $param2 = "") {
    ...
    if ($param1 == 'add') {
      ...
      redirect('instructor/course_form/course_edit/'.$course_id);
    }
    elseif ($param1 == 'edit') {
    ...
    elseif ($param1 == 'filter') {
      redirect('instructor/lessons/'.$this->input->post('course_id'));
    }
  ...
  public function manage_language($param1 = '', $param2 = '', $param3 = ''){
    if ($param1 == 'add_language') {
      ...
      redirect(site_url('instructor/manage_language'), 'refresh');
    }
  ...
  function manage_profile($param1 = '', $param2 = '', $param3 = '')
  {
    ...
    if ($param1 == 'update_profile_info') {
      $this->user_model->edit_user($param2);
      redirect(site_url('instructor/manage_profile'), 'refresh');
    }
  ...
  public function payment_success($payment_type = "", $payment_id = "") {
    ...
    redirect(site_url('instructor/instructor_revenue'), 'refresh');
  }
